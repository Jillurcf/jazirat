...
const MaterialsAndTech = () => {
  return (
    <div className="p-4 max-w-[70%] items-center mx-auto -mt-8 lg:mt-0">
         <h2 className="lg:text-3xl text-xl text-[#D4AB45] text-center mt-12 font-bold py-6">Materials We Use</h2>
